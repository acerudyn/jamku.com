...
www.jamku.com </div>
    ...
    <div class="center_content">
      <div class="center_title_bar">Admin</div>
  ...
  <tr>
    <td width="73" align="center">ID</td>
    <td width="130" align="center">Nama</td>
    <td width="102" align="center">Username</td>
...
?>         
  <tr>
    ...
    <td align="center"> <a href="edit-validasi.php?  edit= <?php echo $data['id_admin']?>" title="edit"><div class="fa fa-pencil fa-1.5x"></div></a> |  <a href="admin-add.php" title="tambah"><div class="fa fa-plus-square fa-1.5x"></div></a> |  <a href="admin-delete.php?  hapus= <?php echo $data['id_admin']?>" title="hapus"><div class="fa fa-remove fa-1.5x"></div></a></td>
    <?php $no++; } ?>
  </tr>
   <?php } ?> 
</table>
