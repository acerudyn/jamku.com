...
www.jamku.com </div>
    ...
    <div class="center_content">
      <div class="center_title_bar">Edit Kategori</div>
...
if(isset($_POST['save'])){
	...
	if (count($pesanError)>=1 ){
		...
		$Kode	= $_POST['txtKode'];
		$mySql	= "UPDATE kategori SET nama_kategori='$txtNama' WHERE id_kategori ='$Kode'";
...
<?php
$kode=$_GET['edt'];
$mySql	 = "SELECT * FROM kategori WHERE id_kategori='$kode'";
$myQry	 = mysql_query($mySql, $konek)  or die ("Query data salah: ".mysql_error());
$myData	 = mysql_fetch_array($myQry);

	// Menyimpan data ke variabel temporary (sementara)
	$datakode	= $myData['id_kategori'];
	$datanama	= isset($_POST['nama']) ? $_POST['nama'] : $myData['nama_kategori'];
?>
              <form  method="post" action="<?php $_SERVER['PHP_SELF']; ?>" target="_self" >
                <table width="326" height="100" border="0">
                  <tr>
                    ...
                    <input name="id_kategori" type="text" value="<?php echo $datakode ?>" readonly="readonly" /></td>
                  </tr>
                  <tr>
                    <td height="30" align="left"><strong>Nama Kategori</strong></td>
                    <td align="center"><strong>:</strong></td>
                    <td align="left"><input type="text" name="nama"value="<?php echo $myData['nama_kategori']; ?>" />
                    </td>
                  </tr>
                  <tr>
                    <td height="27">&nbsp;</td>
