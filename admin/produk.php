...
www.jamku.com </div>
    ...
    <div class="center_content1">
      <div class="center_title_bar3">PRODUK</div>
      <div class="prod_box_big1">
        
        
            <div class="form_row3">
              <label class="contact">
              <table width="675" height="125" border="0">
  <tr>
    <td width="49" align="center">ID</td>
    <td width="101" align="center">Gambar</td>
    <td width="57" align="center">Nama</td>
    <td width="67" align="center">Konsumen</td>
    <td width="55" align="center">Kategori</td>
    <td width="54" align="center">Brand</td>
    <td width="56" align="center">Harga</td>
    <td width="56" align="center">Aksi</td>
  </tr>
  <tr>
    <td height="18" colspan="8" align="left">---------------------------------------------------------------------------------------------------------------------------------------------------------------------</td>
    </tr>
<?php include "koneksi.php";
$query=mysql_query("select * from produk order by id_produk desc limit $start, $per_hal");
	while($data=mysql_fetch_array($query)){
?>      
  <tr>
    <td height="79" align="center"><?php echo $data['id_produk']; ?></td>
    <td align="center"><img src="../gambar_jam/<?php echo $data['gambar']; ?>" border="0" width="90" height="100" /></td>
    <td align="center"><?php echo $data['nama_produk']; ?></td>
    <td align="center"><?php echo $data['konsumen']; ?></td>
    <td align="center"><?php echo $data['id_kategori']; ?></td>
    <td align="center"><?php echo $data['id_brand']; ?></td>
    <td align="center"><?php echo $data['harga']; ?></td>
    <td align="center"> <a href="produk-edit.php?edit=<?php echo $data['id_produk']; ?>" title="edit"><div class="fa fa-pencil fa-1.5x"></div></a> |  <a href="produk-add.php" title="tambah"><div class="fa fa-plus-square fa-1.5x"></div></a> |  <a href="produk-delete.php?hapus=<?php echo $data['id_produk']; ?>" title="hapus"><div class="fa fa-remove fa-1.5x"></div></a></td>
  </tr>
   <?php } ?> 
</table>
...
<a href="?page=<?php if ($page>1){$page-1;} echo $page ?>"> < </a>
<?php 
...
?><a href="?page=<?php if ($x<$halaman){$page+1;}echo $page ?>"> > </a>
	</span>  </div>
        </div> 
