...
<?php
$produk	= $_GET['detail'];
$sql	= mysql_query("SELECT * FROM pemesanan WHERE id_produk=$produk ");
...
?>        
  ...
  <tr>
    ...
    <td width="402"><strong><?php echo $lihat['id_pesan']; ?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><strong>
	<?php
	$query1=mysql_query("SELECT * FROM transaksi WHERE id_transaksi='$lihat[id_pesan]'");
	$datamember=mysql_fetch_array($query1);
	 echo $datamember['penerima']; ?></strong></td>
  </tr>

  <tr>
    <td><strong>Alamat Lengkap</strong></td>
    <td align="left"><strong>:</strong></td>
    <td><strong><?php echo $datamember['alamat']; ?></strong></td>
  </tr>
  <tr>
...
<table width="620" height="298" border="0" align="center">
  <tr>
...
<?php 
$tampil=mysql_query("select * from pemesanan where id_produk='$produk' order by id_produk desc");
