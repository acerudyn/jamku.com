...
include "session.php";
	$per_hal=20;
	$jumlah_record=mysql_query("SELECT COUNT(*) from contact");
...
www.jamku.com </div>
    ...
    <div class="center_content">
      <div class="center_title_bar">Contact</div>
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          <div class="contact_form1">
            <div class="form_row1">
              <label class="contact">
              <table width="514" height="71" border="0">
  <tr>
    <td width="73" align="center">Nama</td>
    <td width="130" align="center">Email</td>
    <td width="102" align="center">Pesan</td>
    <td width="91" align="center">Aksi</td>
  </tr>
  <tr>
    <td height="18" colspan="4" align="left">------------------------------------------------------------------------------------------------------------------------------</td>
    </tr>
<?php
$query=mysql_query("select * from contact order by id_contact desc limit $start, $per_hal");
	while($data=mysql_fetch_array($query)){
?>
  <tr>
    <td align="center"><?php echo $data['nama_contact']; ?></td>
    <td align="center"><?php echo $data['email']; ?></td>
    <td align="center"><?php echo $data['pesan']; ?></td>
    <td align="center"><a href="mailto:<?php echo $data['email'];?>" title="balas"><div class="fa fa-reply fa-1.5x"></div></a> |  <a href="admin-delete.php?  hapus= <?php echo $data['id_contact']?>" title="hapus"><div class="fa fa-remove fa-1.5x"></div></a></td>
  </tr>
   <?php } ?> 
</table>
