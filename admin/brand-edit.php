...
www.jamku.com </div>
    ...
    <div class="center_content">
      <div class="center_title_bar">Edit Brands</div>
...
if(isset($_POST['save'])){
	...
	if (count($pesanError)>=1 ){
		...
		$Kode	= $_POST['txtKode'];
		$mySql	= "UPDATE brand SET nama_brand = '$txtNama' WHERE id_brand = '$Kode' ";
...
<?php
$kode=$_GET['edit'];
$mySql	 = "SELECT * FROM brand WHERE id_brand='$kode'";
$myQry	 = mysql_query($mySql, $konek)  or die ("Query data salah: ".mysql_error());
$myData	 = mysql_fetch_array($myQry);

	// Menyimpan data ke variabel temporary (sementara)
	$datakode	= $myData['id_brand'];
	$datanama	= isset($_POST['nama_brand']) ? $_POST['nama_brand'] : $myData['nama_brand'];
?>              
              <form  name="form1" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" target="_self" >
                <table width="326" height="100" border="0">
                  <tr>
                    <td width="85" height="32" align="left"><strong>ID Brands</strong></td>
                    <td width="13" align="center"><strong>:</strong></td>
                    <td width="206" align="left">
                    <input type="hidden"  name="txtKode" value="<?php echo $datakode; ?>">
                    <input name="id_brand" type="text" readonly="readonly" value="<?php echo $datakode; ?>" /></td>
                  </tr>
                  <tr>
                    <td height="30" align="left"><strong>Nama Brands</strong></td>
                    <td align="center"><strong>:</strong></td>
                    <td align="left"><input type="text" name="nama_brand" value="<?php echo $myData['nama_brand']; ?>"/></td>
                  </tr>
                  <tr>
                    <td height="27">&nbsp;</td>
                    <td>&nbsp;</td>
