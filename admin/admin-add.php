...
www.jamku.com </div>
    ...
    <div class="center_content">
      <div class="center_title_bar">Add Admin</div>
...
?>              
              ...
              <form  name="form1" method="post" action="admin-save.php">
                <table width="326" height="126" border="0">
                  <tr>
                    <td width="85" align="left"><strong>Nama</strong></td>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="top"><input type="password" name="password" value="<?php echo isset($_POST['password']) ? $_POST['password'] : '';?>" /> <br/> <span style="color:#06C; font-size:11px;">*)password minimal 5 karakter</span> <br/>
                    <span style="color:#F00; font-size:9px;"><?php echo isset($error['password']) ? $error['password']:''; ?></span>
                    <span style="color:#F00; font-size:9px;"><?php echo isset($error['panjang']) ? $error['panjang']:''; ?></span></td>
                  </tr>
                  <tr>
                    <td height="28" align="left" valign="top"><strong>Konfirmasi Password</strong></td>
                    <td align="center" valign="top"><strong>:</strong></td>
                    <td align="left" valign="top"><input type="password" name="konfirmasi_pwd" value="<?php echo isset($_POST['konfirmasi_pwd']) ? $_POST['konfirmasi_pwd'] : '';?>" /> <br/>
