...
include "session.php";
	$per_hal=15;
	$jumlah_record=mysql_query("SELECT COUNT(*) from testimonial");
...
www.jamku.com </div>
    ...
    <div class="center_content">
      <div class="center_title_bar">Tesimonial</div>
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          <div class="contact_form1">
            <div class="form_row1">
              <label class="contact">
              <table width="492" height="107" border="0">
  <tr>
    <td width="117" height="24" align="center">Nama</td>
    <td width="316" align="center">Testimonial</td>
    <td width="37" align="center">Aksi</td>
  </tr>
  <tr>
    <td height="18" colspan="3" align="left">-----------------------------------------------------------------------------------------------------------------------</td>
    </tr>
<?php
$query=mysql_query("select * from testimonial order by id_testimonial desc limit $start, $per_hal");
...
?>
  <tr>
    <td height="55" align="left" valign="top"><?php echo $bacadata['nama_member']; ?></td>
    <td align="left" valign="top"><?php echo $data['isi']; ?></td>
    <td align="center"> <a href="testimonial-delete.php" title="hapus"><div class="fa fa-remove fa-1.5x"></div></a></td>
  </tr>
   <?php } ?>
</table>
