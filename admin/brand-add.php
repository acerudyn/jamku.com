...
www.jamku.com </div>
    ...
    <div class="center_content">
      <div class="center_title_bar">Add Brands</div>
...
?>  
              <form name="form1" method="post" action="brand-save.php">
                <table width="326" height="100" border="0">
                  <tr>
                    ...
                    <input type="text" name="id_brand"  value="<?php echo isset($_POST['id_brand']) ? $_POST['id_brand'] : '';?>" /> <br/> <span style="color:#F00; font-size:9px;"><?php echo isset($error['id']) ? $error['id']:''; ?></span>
                    </td>
                  </tr>
                  <tr>
                    <td height="30" align="left"><strong>Nama Brands</strong></td>
                    <td align="center"><strong>:</strong></td>
                    <td align="left"><input type="text" name="nama_brand"  value="<?php echo isset($_POST['nama_brand']) ? $_POST['nama_brand'] : '';?>" /> <br/> <span style="color:#F00; font-size:9px;"><?php echo isset($error['nama']) ? $error['nama']:''; ?></span>
                    </td>
                  </tr>
                  <tr>
                    <td height="27">&nbsp;</td>
