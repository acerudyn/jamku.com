...
www.jamku.com </div>
    ...
    <div class="center_content">
      <div class="center_title_bar">Brands</div>
  ...
  <tr>
    <td align="center">ID Brands</td>
    <td align="center">Nama Brands</td>
...
include"session.php";
$no=1;
$tampil=mysql_query("select * from brand order by id_brand desc");
...
?>   
  ...
  <tr>
    ...
    <td align="center"><?php echo $data['nama_brand']; ?></td>
    <td align="center"> <a href="brand-edit.php?edit=<?php echo $data['id_brand']; ?>" title="edit"><div class="fa fa-pencil fa-1.5x"></div></a> |  <a href="brand-add.php" title="tambah"><div class="fa fa-plus-square fa-1.5x"></div></a> |  <a href="brand-delete.php?hapus=<?php echo $data['id_brand']; ?>" title="hapus"><div class="fa fa-remove fa-1.5x"></div></a></td>
    <?php $no++; } ?>
  </tr>
  <?php } ?> 
</table>
