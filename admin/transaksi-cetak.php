...
www.jamku.com </div>
    ...
    <div class="center_content1">
      <div class="center_title_bar1">Faktur Transaksi</div>
   	  <div class="prod_box1">
<?php
...
<table width="620" height="240" border="0" align="center">
  <tr>
...
<div class="center_title_bar1">Data Pengiriman</div>
   	  <div class="prod_box1">
   	    <table width="620" border="0" align="center">
   	      <tr>
   	        <td width="156"><strong>Nama Pengirim</strong></td>
   	        <td width="48" align="left"><strong>:</strong></td>
   	        <td width="402"><strong>Jamku.com</strong></td>
          </tr>
   	      <tr>
   	        <td><strong>Alamat</strong></td>
   	        <td align="left"><strong>:</strong></td>
   	        <td><strong>Jalan Kutoarjo - Kebumen Km 07 Kec. Butuh, Kab. Purworejo, Prov. Jawa Tengah</strong></td>
          </tr>
   	      <tr>
   	        <td><strong>Nomor Telepon</strong></td>
   	        <td align="left"><strong>:</strong></td>
   	        <td><strong>085228053623</strong></td>
          </tr>
   	      <tr>
   	        <td><strong>Nomor Transaksi</strong></td>
   	        <td align="left"><strong>:</strong></td>
   	        <td><strong><?php echo $lihat['id_transaksi']; ?></strong></td>
          </tr>
   	      <tr>
   	        <td height="18" colspan="3"><strong>--------------------------------------------------------------------------------------------------------------------------------------------------------</strong></td>
          </tr>
