...
?>      
 ...
 <?php
	$per_hal=9;
	$jumlah_record=mysql_query("SELECT COUNT(*) from produk where id_kategori ");
...
?>
	...
	$query=mysql_query("select * from produk where id_kategori='$kategori' order by id_produk desc limit $start, $per_hal");
