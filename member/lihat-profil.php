...
?>            
              ...
              <form name="form1" method="post" action="">
                <table width="393" height="219" border="0">
                  <tr>
                    <td width="198" rowspan="5" align="left" valign="middle">
                    <img src="images/user.png" alt="user.png" width="169" height="169"  /></td>
                    <td height="27" align="left" valign="bottom"><div class="fa fa-lock fa-1x"></div> <strong><?php echo $data['id_member'];?></strong></td>
                  </tr>
                  <tr>
                    <td width="179" height="25" align="left" valign="bottom"><div class="fa fa-user fa-1x"></div> <strong><?php echo $data['nama_member'];?></strong></td>
                  </tr>
                  <tr>
                    <td height="25" align="left" valign="bottom"><div class="fa fa-envelope fa-1x"></div> <strong><?php echo $data['email'];?></strong></td>
                  </tr>
                  <tr>
                    <td height="25" align="left" valign="bottom"><div class="fa fa-mobile fa-2x"></div> <strong><?php echo $data['telepon'];?></strong></td>
                  </tr>
                  <tr>
                    <td height="26" align="left" valign="middle"><div class="fa fa-pencil fa-1.5x"></div>
                    <a href="edit-profil.php?edit=<?php echo $data['id_member']; ?>"><strong>edit profil</strong></a></td>
                  </tr>
                  <tr>
