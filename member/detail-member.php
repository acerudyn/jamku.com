...
?>           
      <div class="prod_box">
        ...
        <div class="center_prod_box">
          ...
          <div class="product_img"><a href="detail-member.php?detail=<?php echo $data['id_produk']; ?>"><img src="../gambar_jam/<?php echo $data['gambar']; ?>" border="0" height="180" width="160" /></a></div>
        ...
        <a href="detail-member.php?detail=<?php echo $data['id_produk']; ?>"><div class="fa fa-eye fa-1.5x"></div> view detail</a> </div>
      </div>
       <?php
	}
?>  
