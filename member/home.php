...
<![endif]-->
<script type="text/javascript" src="file:///C|/xampp/htdocs/jam/js/boxOver.js"></script>
...
www.jamku.com </div>
            <a href="file:///C|/xampp/htdocs/jam/details.html" class="details">details</a> </div>
        </div>
      </div>
...
?>     
      ...
      <div class="prod_box">
        <div class="center_prod_box">
          ...
          <div class="product_img"><a href="detail-member.php?detail=<?php echo $data['id_produk']; ?>"><img src="../gambar_jam/<?php echo $data['gambar']; ?>" border="0" width="160" height="180" /></a></div>
        ...
        <a href="detail-member.php?detail=<?php echo $data['id_produk']; ?>"><div class="fa fa-eye fa-1.5x"></div> view detail</a>
         </div>
      </div>
     <?php
	}
