...
<li><a href="logout.php">Log Out</a></li>
    ...
    <div class="title_box">Categories</div>
      ...
      <ul class="left_menu">
        ...
        <li class="odd"><a href="search-brand-member.php?brand=<?php echo"dgt"; ?>">Digitec</a></li>
...
?>      
    ...
    <div class="center_content">
      <div class="center_title_bar">Result Search</div>
      
<?php
	$per_hal=9;
	$jumlah_record=mysql_query("SELECT COUNT(*) from produk where id_brand ");
...
?>
      ...
      <?php
	  $kode= $_GET['brand']; 
	$query=mysql_query("select * from produk where id_brand='$kode' order by id_produk desc limit $start, $per_hal ");
