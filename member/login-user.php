...
?>      
    ...
    <div class="center_content">
      <div class="center_title_bar">Login Member</div>
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          <div class="contact_form">
            <div class="form_row">
              <label class="contact">
              <form name="form1" method="post" action="login-validasi.php">
              <table width="327" height="38" border="0">
  <tr>
    <td width="249" height="32" align="center" valign="middle"><div class="fa fa-user fa-1.5x"></div><strong> Username</strong><br/><input name="username" type="text" placeholder="username"/><br/>
    <div class="fa fa-eye-slash fa-1.5x"></div><strong> Password</strong><br/><input name="password" type="password" placeholder="password" /><br/>
