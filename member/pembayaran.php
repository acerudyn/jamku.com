              ...
              <form name="form1" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" target="_self">
                <table width="373" height="350" border="0">
                  <tr>
                    ...
                    <input name="nama" type="text" value="<?php echo $data['nama_member']; ?>" readonly="readonly" /></td>
                  </tr>
                  <tr>
...
?>                  
                    <td align="left">
                    <textarea name="" cols="30" rows="5" readonly="readonly"><?php echo $data['alamat'];?></textarea>
                    <input name="alamat" type="hidden" value="<?php echo "$data[alamat] Kec. $kecamatan[name] $kabupaten[name] Prov. $provinsi[name]"; ?>"  /></td>
                  </tr>
                  <tr>                                    
                  ...
                  <tr>                 
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td align="left"><input name="kecamatn" type="text" readonly="readonly" value="<?php echo $kecamatan['name']; ?>" /></td>
                  </tr>
                  <tr>
                    <td height="25" align="left"><strong>Nomor Hp</strong></td>
                    <td align="center"><strong>:</strong></td>
                    <td align="left"><input name="telepon" type="text" value="<?php echo $data['telepon']; ?>" readonly="readonly" /></td>
                  </tr>
                  <tr>
                    <td height="25" align="left"><strong>Email</strong></td>
                    <td align="center"><strong>:</strong></td>
                    <td align="left"><input name="email" type="text" value="<?php echo $data['email']; ?>" readonly="readonly" /></td>
                  </tr>
                  <tr>
...
?>                  
                    ...
                    <td align="center"><strong>:</strong></td>
                    <td align="left"><input name="biaya_kirim" type="text" readonly="readonly" value="<?php echo $tarif['jnereg']; ?>" /></td>
                  </tr>
                  <tr>
<?php 
...
?>                  
                  ...
                  <tr>
                    ...
                    <td align="center">&nbsp;</td>
                    <td align="left" valign="top"><a href="edit-alamat.php" title="edit alamat"><div class="fa fa-pencil fa-1.5x"></div>Edit Alamat</a> | <input type="submit" name="save" value="Submit" /></td>
                  </tr>
                </table>
              </form>
              </label>
