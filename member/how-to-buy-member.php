...
<li class="divider"></li>
<li><a href="how-to-buy-member.php">Complete Guide</a></li>
<li class="divider"></li>
...
?>      
  ...
  <tr>
    <td height="325" colspan="3" align="left" valign="top"><div class="fa fa-user fa-1.5x"></div>
      ...
      <strong> Testimonial</strong> <br/>Jangan lupa berikan feedback dan testimonial kamu tentang produk atau toko kami<br/>
      --------------------------------------------------------------------------------------------------<br/>
    </td>
    </tr>
  <tr>
